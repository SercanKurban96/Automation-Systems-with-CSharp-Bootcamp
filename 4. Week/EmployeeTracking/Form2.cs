...
namespace EmployeeTracking
{
    public partial class Form2 : Form
    {
        ...
        private void kullaniciListesi()
        {
            ...
            {
                baglantim.Open();
                OleDbDataAdapter kullanici_listesi = new OleDbDataAdapter("select tcno as[TC Numarası],ad as[Adı],soyad as[Soyadı],yetki as[Yetki],kullanici as[Kullanıcı],parola as[Parola] from kullanici order by ad ASC", baglantim);
        ...
        private void personelListesi()
        {
            ...
            {
                baglantim.Open();
                OleDbDataAdapter personel_listesi = new OleDbDataAdapter("select tcno as[TC Numarası],ad as[Adı],soyad as[Soyadı],cinsiyet as[Cinsiyet],dogumtarihi as[Doğum Tarihi],gorevi as[Görevi] from personeller order by tcno ASC", baglantim);
                DataSet dshafiza = new DataSet();
        ...
        private void Form2_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                string a = $"{Application.StartupPath}\\kullaniciresimleri\\{Form1.tcno}.jpg";
            ...
            comboBox1.Items.Add("Halkla İlişkiler");
        ...
        private void textBox5_TextChanged(object sender, EventArgs e)
        {
            ...
            else if (parola_skoru >= 60 || parola_skoru <= 85)
            {
            ...
            if (kayitkontrol == false)
            {
                ...
                if (textBox1.Text.Length == 11 && textBox1.Text != "" && textBox2.Text.Length > 1 && textBox2.Text != "" && textBox3.Text.Length > 1 && textBox3.Text != "" && textBox4.Text != "" && textBox5.Text != "" && textBox6.Text != "" && textBox5.Text == textBox6.Text && parola_skoru >= 65)
                {
                    ...
                    try
                    {
                        ...
                        baglantim.Close();
                        MessageBox.Show("Kullanıcı başarılı bir şekilde kaydedildi!", "Kayıt Gerçekleşti", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        topPage1_clear();
                        kullaniciListesi();
                    }
                    catch (Exception ex)
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (textBox1.Text.Length == 11 && textBox1.Text != "" && textBox2.Text.Length > 1 && textBox2.Text != "" && textBox3.Text.Length > 1 && textBox3.Text != "" && textBox4.Text != "" && textBox5.Text != "" && textBox6.Text != "" && textBox5.Text == textBox6.Text && parola_skoru >= 65)
            {
                ...
                try
                {
                    ...
                    baglantim.Close();
                    MessageBox.Show("Kullanıcı başarılı bir şekilde güncellendi!", "Kayıt Güncellendi", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    topPage1_clear();
                    kullaniciListesi();
                }
                catch (Exception ex)
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            if (textBox1.Text.Length == 11)
            {
                ...
                while (kayitokuma.Read())
                {
                    ...
                    baglantim.Close();
                    MessageBox.Show("Kullanıcı başarılı bir şekilde silindi!", "Kayıt Silindi", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    kullaniciListesi();
                    topPage1_clear();
                    break;
                }
            ...
            if (kayitKontrol == false)
            {
                ...
                if (pictureBox2.Image != null && maskedTextBox1.MaskCompleted != false && maskedTextBox2.MaskCompleted != false && maskedTextBox3.MaskCompleted != false && maskedTextBox4.MaskCompleted != false && comboBox1.Text != "" && comboBox2.Text != "")
                {
                    ...
                    try
                    {
                        ...
                        MessageBox.Show("Yeni Personel Oluşturuldu!", "Personel Kayıt Sistemi", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        personelListesi();
                        topPage2_clear();
                    }
                    catch (Exception ex)
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            if (pictureBox2.Image != null && maskedTextBox1.MaskCompleted != false && maskedTextBox2.MaskCompleted != false && maskedTextBox3.MaskCompleted != false && maskedTextBox4.MaskCompleted != false && comboBox1.Text != "" && comboBox2.Text != "")
            {
                ...
                {
                    baglantim.Open();
                    OleDbCommand guncellemekomutu = new OleDbCommand("update personeller set ad='" + maskedTextBox2.Text + "',soyad='" + maskedTextBox3.Text + "',cinsiyet='" + cinsiyet + "',dogumtarihi='" + dateTimePicker1.Text + "',gorev='" + comboBox1.Text + "',gorevyeri='" + comboBox2.Text + "',maas='" + maskedTextBox4.Text + "' where tcno='" + maskedTextBox1.Text + "'", baglantim);
                    guncellemekomutu.ExecuteNonQuery();
                    baglantim.Close();

                    MessageBox.Show("Personel Güncellendi!", "Personel Güncelleme Sistemi", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    personelListesi();
                    topPage2_clear();
                }
                catch (Exception ex)
                {
                    MessageBox.Show(ex.Message, "Personel Güncelleme Sistemi", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
            else
            {
                MessageBox.Show("Yazı rengi kırmızı olan alanları kontrol ediniz!", "Personel Güncelleme Sistemi", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            if (maskedTextBox1.MaskCompleted == true)
            {
                ...
                {
                    MessageBox.Show("Silinecek personel bulunamadı.", "Personel Silme Ekranı", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
                baglantim.Close();
                personelListesi();
                topPage2_clear();
